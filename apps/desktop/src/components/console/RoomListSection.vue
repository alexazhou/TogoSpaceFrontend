...
.room-card:hover,
.room-card.selected {
  background: color-mix(in srgb, var(--interactive-selected) 78%, var(--surface-panel-muted) 22%);
...
.placeholder {
  padding: 10px 12px;
  border-radius: 12px;
  background: color-mix(in srgb, var(--surface-panel-muted) 92%, var(--surface-panel) 8%);
  color: var(--text-secondary);
  font-size: 0.78rem;
}
